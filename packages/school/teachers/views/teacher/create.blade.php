...
@section('contentheader_title')
    <i class="fa fa-suitcase"></i> Create Teacher
@endsection
...
<div class="row">
    <div class="col-md-12">
        ...
        <div class="box box-info">
            <!-- form start -->
            <form role="form" method="POST" class="form-horizontal" action="{{ route('teachers.store')}}" enctype="multipart/form-data" encoding="multipart/form-data">
                {!! csrf_field() !!}
                <div class="box-body">
