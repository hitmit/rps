...
@section('contentheader_title')
    <i class="fa fa-suitcase"></i> Edit Teacher
@endsection
...
<div class="row">
    <div class="col-md-12">
        ...
        <div class="box box-info">
            <!-- form start -->
            <form role="form" method="POST" class="form-horizontal" action="{{ route('teachers.update', $user->id)}}" enctype="multipart/form-data" encoding="multipart/form-data">
                {!! csrf_field() !!}
