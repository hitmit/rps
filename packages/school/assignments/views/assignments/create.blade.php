...
@section('contentheader_title')
    <i class="fa fa-file-pdf-o"></i> Add Study Material
@endsection
            ...
            {!! Form::open(['route' => 'assignments.store', 'files' => true]) !!}
                <div class="box-body">
                    ...
                    <div class="form-group">
                        ...
                        {!! Form::date('AssignDeadLine', null, ['class' => 'form-control']) !!}
                    </div>
                ...
                <div class="box-footer">
                    ...
                    <button type="submit" class="btn btn-info pull-right">Add Assignment</button>
                </div><!-- /.box-footer -->
            {!! Form::close(); !!}<!-- /form -->
        </div><!-- /.box -->
    </div>
