...
@section('contentheader_title')
    <i class="fa fa-graduation-cap"></i> Edit Exam
@endsection
...
<div class="row">
    <div class="col-md-12">
        ...
        <div class="box box-info">
            <!-- form start -->
            {!! Form::model($examlist, ['route' => array('examlist.update', $examlist->id), 'method' => 'PUT' ]) !!}
                <div class="box-body">
                ...
                <div class="box-footer">
                    ...
                    <button type="submit" class="btn btn-info pull-right">Edit Exam</button>
                </div><!-- /.box-footer -->
            {!! Form::close() !!}
        </div><!-- /.box -->
    </div>
