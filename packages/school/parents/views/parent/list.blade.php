    ...
    <div class="col-xs-12">
        ...
        <div class="box">
            <div class="box-header">
                ...
                <div class="box-tools">
                    <a href="{{ route('parents.create') }}" class="btn btn-primary btn-flat">Add Parent</a>
            ...
            <div class="box-body table-responsive no-padding">
                <table class="table table-hover">
                    ...
                    <tr>
                        ...
                        <td>
                            <a  role="menuitem" tabindex="-1" data-toggle="modal" data-target="#UserModal" href="{{ route('parents.show', $value->id) }}">{{ $value->email  }}</a>
                        </td>
                        <td>
                            <a href="{{ route('parents.edit', $value->id) }}" title="Edit"><i class="fa fa-pencil-square-o"></i></a>/
                            <a href="{{ route('parents.confirm', $value->id) }}" title="Delete"><i class="fa fa-trash-o"></i></a>
                        </td>
                    </tr>
                    @endforeach
                </table>
