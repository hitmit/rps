...
<div class="modal-body">
  {!! Form::model($schedule, ['route' => ['class.schedule.update', $schedule->id], 'method' => 'PUT', 'class' => 'form-horizontal' ]) !!}
    ...
    <div class="form-group">
      <div class="col-sm-offset-2 col-sm-12">
        <button type="submit" class="btn btn-default">Edit Schedule</button>
      </div>
    </div>
  {!! Form::close() !!}
</div>
